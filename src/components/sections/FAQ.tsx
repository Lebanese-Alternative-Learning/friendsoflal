...
import { resolveFAQ, resolve } from "@/utils/dataLoader";
    ...
    <section id="faq" className="bg-background section-padding scroll-mt-20">
      <div className="container-narrow">
        <div className="max-w-2xl mx-auto text-center">
          <p className="eyebrow">{resolve(data, "faq-eyebrow", "FAQ")}</p>
          <h2 className="mt-4 text-3xl md:text-5xl font-extrabold text-brand-grey leading-tight">
            {resolve(data, "faq-heading", "Questions, Answered.")}
          </h2>
        </div>
        ...
        <div className="mt-12 max-w-2xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            {defaultFaqs.map((f, i) => {
              const { q, a } = resolveFAQ(data, i, f.q, f.a);
              return (
