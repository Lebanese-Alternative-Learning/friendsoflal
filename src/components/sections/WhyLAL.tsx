        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="mt-4 text-3xl md:text-4xl font-extrabold text-brand-grey leading-tight">
              Education That Continues—<br />No Matter What.
            </h2>
            <p className="mt-6 text-base text-brand-grey/85 leading-relaxed">
            ...
            <a
              href="#about"
              className="mt-8 inline-flex items-center gap-1 font-bold text-brand-magenta hover:underline underline-offset-4"
            >
          ...
          {/* Pillars */}
          <div className="lg:col-span-4 grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-4">
