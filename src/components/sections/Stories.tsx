      ...
      <div className="container-narrow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14">
          ...
          <div>
            ...
            <p className="mt-5 text-sm md:text-base text-brand-grey/85 leading-relaxed max-w-md">
            ...
            <div className="mt-8 bg-brand-soft/25 rounded-2xl p-5 flex gap-4">
              <img
                src={talaPortrait}
          ...
          <div>
            ...
            <a href="#" className="mt-8 relative block rounded-2xl overflow-hidden group shadow-sm hover:shadow-md transition-shadow">
              <img
                src={mediaThumb}
